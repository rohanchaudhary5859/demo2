    ...
    function initMap() {
        ...
        if (pinRed) {
            for (i = 0; i < footerLocation.length; i++) {
                marker = new google.maps.Marker({
                    ...
                    icon: 'KcPVmZx/red-Icon-Location.png'
                });
            }
        } else if (pinYellow) {
            for (i = 0; i < footerLocation.length; i++) {
                marker = new google.maps.Marker({
                    ...
                    map: map,
                    animation: google.maps.Animation.DROP,
                    icon: 'rZg3M67/yellow-Icon-Location.png'
                });
            }
        } else {
            for (i = 0; i < footerLocation.length; i++) {
                marker = new google.maps.Marker({
                    ...
                    map: map,
                    animation: google.maps.Animation.DROP,
                    icon: 'qphb14X/green-Icon-Location.png'
                });
            }
        }
        ...
        if (servicesMapId) {
            ...
            marker = new google.maps.Marker({
                ...
                map: map,
                animation: google.maps.Animation.DROP,
                icon: 'DYSHQ1G/green-Icon-big-Location.png'
            });
        }
        ...
        if (contactMapId) {
            ...
            marker = new google.maps.Marker({
                ...
                map: map,
                animation: google.maps.Animation.DROP,
                icon: 'GR5cVt4/green-Icon-md-Location.png'
            });
        }
